    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="hidden sm:flex items-center gap-2 text-[11px] text-slate-400">
          ...
          <span className="inline-flex items-center gap-1.5">
            <MessageSquare className="w-3.5 h-3.5 text-slate-300" /> Read-only
          </span>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-14 text-center shadow-sm">
          ...
          <p className="text-xs text-slate-400 mt-1">Try a different term or clear the search.</p>
          {debouncedSearch && (
            <button
              onClick={() => setSearch('')}
            ...
            {rows.map((r) => (
              ...
              >
                <td className="pl-5 pr-3 py-3.5">
                  ...
                  <span className="block font-mono text-[10px] text-slate-400 mt-1 truncate max-w-[140px]" title={r.id}>
                    {r.id}
                  </span>
                </td>
                <td className="px-3 py-3.5 max-w-[220px]">
                  ...
                  {r.adId && <span className="block text-[10px] font-mono text-slate-400 truncate mt-0.5">{r.adId.slice(0, 12)}…</span>}
                </td>
                ...
                <td className="px-3 py-3.5 whitespace-nowrap text-xs text-slate-500">{formatDate(r.updatedAt)}</td>
                <td className="px-3 py-3.5">
            ...
            <div className="bg-slate-50 rounded-2xl border border-slate-100 p-4">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                <div className="min-w-0">
                  <p className="text-[11px] font-bold uppercase tracking-wide text-slate-400">Advertisement</p>
                  ...
                  <p className="text-[11px] font-mono text-slate-400 mt-1 truncate">Ad: {selected.adId || '—'} · Conversation: {selected.id}</p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-3 mt-4 text-center">
                ...
                <div className="bg-white rounded-xl border border-slate-100 px-3 py-2.5">
                  <p className="text-[10px] font-bold uppercase tracking-wide text-slate-400">Messages</p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`max-w-[78%] rounded-2xl px-4 py-3 border ${isBuyer ? 'bg-white border-slate-100' : 'bg-[#0F172A] border-[#0F172A] text-white'}`}>
                        <p className={`text-[11px] font-bold ${isBuyer ? 'text-slate-500' : 'text-slate-300'}`}>
