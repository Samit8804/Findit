            ...
            {rows.map((u) => (
              <tr key={u.id} className="hover:bg-slate-50/60 transition-colors">
                ...
                <td className="px-3 py-3.5 max-w-[180px]">
                  <span className="block text-xs text-slate-600 truncate" title={u.email}>
                    {u.email}
                  </span>
                </td>
                ...
                <td className="px-3 py-3.5">
                  <Link href={`/admin/ads?user=${u.id}`} className="inline-flex items-center gap-1 text-xs font-bold text-slate-700 hover:text-[#E53935] transition-colors" title="Review ads">
