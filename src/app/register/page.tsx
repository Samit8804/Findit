  ...
  return (
    ...
    >
      <form onSubmit={submit} noValidate className="space-y-4" aria-label="Registration form">
        ...
        <div>
          <label className="flex items-start gap-2.5 cursor-pointer select-none">
            ...
            <span className="text-xs text-slate-600 leading-relaxed">
              I accept the{' '}
              <a href="#" className="text-[#E53935] font-semibold hover:underline">terms &amp; conditions</a>{' '}
              and privacy policy.
            </span>
          </label>
        ...
        <a href="#" onClick={(e) => e.preventDefault()} className="w-full flex items-center justify-center gap-3 py-3 border border-slate-200 rounded-xl text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors">
