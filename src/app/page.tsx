...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] flex flex-col font-sans">
      ...
      <JsonLd
        data={breadcrumbJsonLd([{ name: 'Home' }])}
      />

      <main className="flex-grow">
        {/* Hero Section - H1 per SEO spec: exactly one primary H1 */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-red-50 text-[#E53935] text-xs font-bold tracking-wide uppercase">
                  <Sparkles className="w-4 h-4" aria-hidden /> Trusted by 2M+ Local Users
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-[#0F172A] leading-[1.1]">
                  Buy & Sell Anything <span className="text-[#E53935]">Near You</span>
                </h1>
                <p className="text-base sm:text-lg text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                  Discover local classifieds on FindIt — vehicles, property, mobiles, jobs, services and trusted businesses near you. Post free ads and connect with verified sellers across India.
                </p>
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-4">
                  <Link href="/browse" aria-label="Browse all classified ads">
                    <Button variant="primary" size="lg" className="shadow-lg">
                      Browse Ads
                    </Button>
                  </Link>
                  <Link href="/post-ad" aria-label="Post a free classified ad">
        ...
        {/* Categories Section - internal linking: homepage → categories */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 gap-4">
              ...
              <Link href="/browse" className="text-sm font-semibold text-[#E53935] hover:underline flex items-center gap-1">
                View All Categories <ArrowRight className="w-4 h-4" aria-hidden />
              </Link>
            </div>
        ...
        {/* Featured Listings Section - internal linking: homepage → featured ads */}
        <section className="py-20 bg-white border-y border-slate-100" aria-labelledby="featured-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 gap-4">
              <div>
                <span className="text-xs font-bold text-[#E53935] tracking-widest uppercase mb-1 block">
              ...
              <Link href="/browse" className="text-sm font-semibold text-[#E53935] hover:underline flex items-center gap-1">
                View All Listings <ArrowRight className="w-4 h-4" aria-hidden />
              </Link>
            </div>
        ...
        {/* Browse By Location Section - internal linking: homepage → locations */}
        <section className="py-20" aria-labelledby="locations-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 gap-4">
              <div>
                <span className="text-xs font-bold text-[#E53935] tracking-widest uppercase mb-1 block">
        ...
        <section className="py-20 bg-white border-y border-slate-100" aria-labelledby="latest-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 gap-4">
              <div>
                <span className="text-xs font-bold text-[#E53935] tracking-widest uppercase mb-1 block">
              ...
              <Link href="/browse" className="text-sm font-semibold text-[#E53935] hover:underline flex items-center gap-1">
                Explore Marketplace <ArrowRight className="w-4 h-4" aria-hidden />
              </Link>
            </div>
